...
public class C12_Pratik_CinZoydagiHesaplama {
    /*
    Java ile kullanıcıdan doğum tarihini alıp Çin Zodyağı değerini hesaplayan program yazınız.

Çin Zodyağı nedir?
4000 bin yıldır kullanılan bir astroloji çeşididir Çin astrolojisi ve insanları 12 değişik
burç ve sembollerle tanımlar. Çin Zodyağı bu 12 burcun eşit aralıklarla(10 derece genişliğinde) sıralandığı
...
Çin Zodyağı Burcunuz : At
    ...
    public static void main(String[] args) {
        ...
        System.out.print("Dogdugunuz yiligiriniz : ");
        yil = scan.nextInt();
        int CinZodiak= yil%12;
        switch (CinZodiak) {
